...
namespace Contas.View
{
    public partial class Contas : Form
    {
        ...
        private void mnuSaveConta_Click(object sender, EventArgs e)
        {
            if (txtConta.Text.Equals(""))
            {
            ...
            try
            {
                ContasMdl contaBD = new ContasMdl();
                Contas contaReg = new Contas(txtCodigo.Text, txtConta);
                string id, string descricao, Boolean ativa, decimal saldo, string data
